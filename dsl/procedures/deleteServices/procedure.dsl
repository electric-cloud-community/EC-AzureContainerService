...
procedure 'Cleanup Cluster - Experimental',
	description: '[Experimental] This procedure is meant for testing purposes only and should not be used in a production environment. It will delete all services pods, deployments and replication controllers in a given Azure Container Service cluster.', {
